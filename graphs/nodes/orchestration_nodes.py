"""Orchestration nodes for master workflow graph."""
...
def intent_classifier_node(state: JobMittrState) -> JobMittrState:
    """Classify user intent using LLM to route workflow.
    
    Args:
        state: Current workflow state
        
    Returns:
        Updated state with classified intent in current_step
    """
...
def error_handler_node(state: JobMittrState) -> JobMittrState:
    """Handle errors gracefully and log to messages.
    
    Args:
        state: Current workflow state with error
        
    Returns:
        Updated state with cleared error and logged message
    """
...
def workflow_complete_node(state: JobMittrState) -> JobMittrState:
    ...
    # Build summary based on completed tasks
